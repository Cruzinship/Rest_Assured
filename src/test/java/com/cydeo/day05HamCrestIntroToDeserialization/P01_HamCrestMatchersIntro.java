...
//HamcrestMatchers comes from RestAssured dependency
    ...
    public void testString() {
        ...
        assertThat(msg, equalToIgnoringCase("api os fun!"));
    ...
    public void testCollections() {
        ...
        assertThat(numberList, containsInRelativeOrder(5, 1, 77, 44));
        //check if you have all the values, position might be different
        assertThat(numberList, containsInAnyOrder(77,5,76,3,1,44));
    }
