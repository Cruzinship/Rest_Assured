...
public class P02_SpartanDeserializationPOJO extends SpartanTestBase {
  ...
  @DisplayName("GET single spartan for deserialization for POJO (Spartan class)")
  @Test
  public void test1() {
  ...
  public void test2() {
    Response response = given()
            ...
            .statusCode(200)
            .extract().response();
//I want to get first spartan from content array and save into the Spartan object
